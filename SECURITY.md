...
- **Signing everyone out:** change `MCP_AUTH_PASSWORD` and redeploy. On startup the server revokes every sign-in, so your MCP clients will ask you to sign in again. Do this if you think your password may have leaked.
